...
//   'F_1.4'  > 'F_1.14'  -> true
//
// The first froze every install that reached F_1.9 — F_1.10 through F_1.14 could never run. The
...
export const catchUpToLatest = (previous: ExtensionSettings): ExtensionSettings => {
  ...
  // F_1.10 (brainstormSystemPrompt) and F_1.14 (brainstormExtractPrompt), plus any built-in prompt
  // the rewind may have dropped. Keyed off SYSTEM_PROMPT_KEYS so later additions are covered too.
